...
if(!is_array_has_empty_input($_POST)){
   ...
   print_r_html($_POST);
    ...
    $insert_to_ab = $db->query('INSERT INTO tb_assembly_build (ab_ref_no, asn_id, asn_ref_no, document_no, sku_code, qty_case, expiry, created_by) VALUES (?,?,?,?,?,?,?,?)',$ab_ref_no, $asn_id, $asn_ref_no, $document_no, $sku_code, $qty_case, $serial_no, $created_by);
